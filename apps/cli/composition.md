...
flowchart LR
  ...
  plugin_dsh_base_codebase_memory["codebase-memory<br/>@deepseek-ai/dsh-codebase-memory"]
  cfg --> plugin_dsh_base_codebase_memory
  plugin_dsh_base_tool_camofox["tool-camofox<br/>@deepseek-ai/dsh-tool-camofox"]
  cfg --> plugin_dsh_base_tool_camofox
...
| `codebase-memory` | `@deepseek-ai/dsh-codebase-memory` |
| `tool-camofox` | `@deepseek-ai/dsh-tool-camofox` |
