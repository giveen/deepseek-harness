...
// message flow. Cards start collapsed unless their owner requests an open
// transition when material arrives; the details panel is the single-call
// full-height reading surface. Expand state is component-local view state.
// File-tool summaries are path
...
import {
  BrowserBlock, CodeBlock, DiffBlock, DisclosureRow, IconInspectOutline12, ReadBlock, SearchBlock, StateDot, TerminalBlock, WebBlock,
} from '@deepseek-ai/dsh-client-ui-primitives'
import type { BrowserBlockProps, WebBlockProps } from '@deepseek-ai/dsh-client-ui-primitives'
...
export interface ToolRowProps {
  ...
  /** Browser screenshot material for a camofox result. */
  browser?: BrowserBlockProps | null | undefined
  /** Whether this specialized card starts open, or opens when this changes to true. */
...
export function ToolRow({
  ...
  const browserBody = browser ?? null
  ...
  const card = terminalBody ?? diffBody ?? readBody ?? searchBody ?? webBody ?? browserBody
              ...
              : readBody !== null
                ...
                : searchBody !== null
                  ...
                  : webBody !== null
                    ...
                    : browserBody !== null
                      ? <BrowserBlock {...browserBody} className={css.browserBody} />
                      : (
                        <>
