...
export interface HeroShellProps {
  ...
  t: HeroTranslate
  /** Optional deployment brand mark; the built-in fish is the fallback. */
  brandMark?: ReactNode
 ...
 */
export function HeroShell({ t, brandMark, children }: HeroShellProps) {
  return (
      ...
      <div className={css.stack}>
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            {brandMark ?? <FishLogo size={34} className={css.fish} />}
          </span>
