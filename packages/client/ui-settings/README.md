...
- **Untrusted remote browsers get no durable settings** — the Host trust fence returns 403 outside loopback and declared trusted authorities; trusted LAN pages use the same durable scope as loopback.
