...
export type {
  ...
  DirectoryEntry, DirectoryListing, GitCommitId,
  ToolCallView, ToolResultView, WorkspaceApi, WorkspaceCommit, WorkspaceCommitsPage,
  WorkspaceFileEntry, WorkspaceFilesPage, WorkspaceId, WorkspaceView,
