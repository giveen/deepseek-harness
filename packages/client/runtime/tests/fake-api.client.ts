...
import type { WorkspaceCommitsPage, WorkspaceFilesPage } from '@deepseek-ai/dsh-host-apiproxy/api'
...
export class FakeApiClient implements IApiClient {
  ...
  onListDirectory: (payload: unknown) => Promise<RpcResponse<{
    ...
    () => Promise.resolve(ok({ path: '/home/fake', home: '/home/fake', separator: '/', crumbs: [{ name: '/', path: '/', hidden: false }], entries: [], truncated: false }))
