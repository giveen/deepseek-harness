/**
 * Package-owned invariant companion for the official browser brand plugin.
...
/** No runtime invariant: this presentation-only package owns no mutable runtime state. */
