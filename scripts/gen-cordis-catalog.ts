...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionPersistenceSnapshotPage: 'persistence.md',
  SessionDeletionMark: 'persistence.md',
  SessionDeletionMarkResult: 'persistence.md',
  SessionDeletionSweepResult: 'persistence.md',
